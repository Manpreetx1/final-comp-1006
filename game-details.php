...
<main class="container">
    ...
    <!-- Display game photo as a thumbnail if it exists -->
    <?php if (!empty($game['photo'])): ?>
        <a href="uploads/<?php echo htmlspecialchars($game['photo']); ?>" target="_blank">
            <img src="uploads/<?php echo htmlspecialchars($game['photo']); ?>" alt="Game Photo" class="thumbnail">
        </a>
    <?php endif; ?>
    ...
    <form method="post" action="save-game.php" enctype="multipart/form-data">
        ...
        <fieldset class="p-2">
            ...
            <input name="releaseYear" id="releaseYear" required type="number" min="1960"
                value="<?php echo htmlspecialchars($game['releaseYear']); ?>" />
        </fieldset>
        <fieldset class="p-2">
            <label for="rating" class="col-2">Rating:</label>
            <input name="rating" id="rating" maxlength="10"
                value="<?php echo htmlspecialchars($game['rating']); ?>" />
        </fieldset>
        <fieldset class="p-2">
        ...
        <input name="gameId" id="gameId" type="hidden" value="<?php echo htmlspecialchars($game['gameId']); ?>" />
        <input name="currentPhoto" id="currentPhoto" type="hidden" value="<?php echo htmlspecialchars($game['photo']); ?>" />
